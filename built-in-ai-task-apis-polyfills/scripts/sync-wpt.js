...
const SOURCES = [
  ...
  {
    api: 'https://api.github.com/repos/web-platform-tests/wpt/contents/ai/summarizer',
    local: path.join(WPT_BASE_DIR, 'summarizer'),
  },
  {
    api: 'https://api.github.com/repos/web-platform-tests/wpt/contents/ai/writer',
    local: path.join(WPT_BASE_DIR, 'writer'),
  },
  {
    api: 'https://api.github.com/repos/web-platform-tests/wpt/contents/ai/rewriter',
...
async function main() {
  ...
  if (fs.existsSync(WPT_BASE_DIR)) {
    ...
    for (const file of existing) {
      if (file === 'index.html' || file === 'util.js') {
        continue;
      }
