 ...
 * Backed exclusively by the LanguageModel API the browser provides. It never
 * loads the Prompt API polyfill, so without `window.LanguageModel` it reports
 * `'unavailable'` and refuses to create a rewriter.
 */
