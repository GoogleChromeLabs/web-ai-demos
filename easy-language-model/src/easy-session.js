...
import { createRawSession } from './create-session.js';
...
/**
 * A `LanguageModel` session with the sharp edges filed off.
 *
 * Everything the raw session does, this does the same way. On top of that,
 * output is vetted with the Sanitizer API, Markdown can be streamed straight
 * out as HTML, and the conversation can be compacted in place.
 */
export class EasySession {
  #session;
  #createOptions;
  #easy;
  #guard;
